...
//
//	go run ./Section-20-Capstone-And-Professional-Delivery-Capstone-planning-hardening-deployment-CI-CD-and-final-review/Day-99/cmd/loadsmoke -url http://127.0.0.1:8098/golang -workers 16 -requests 5000
//
