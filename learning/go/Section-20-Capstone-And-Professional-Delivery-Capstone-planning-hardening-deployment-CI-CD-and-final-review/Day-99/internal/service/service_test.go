...
func (r *memoryRepo) DailyStats(_ context.Context, code domain.Code, _ int) ([]store.DailyStat, error) {
	r.mu.Lock()
	defer r.mu.Unlock()
	...
	return []store.DailyStat{{Day: "2026-09-02", Count: r.clicks[code]}}, nil
}
